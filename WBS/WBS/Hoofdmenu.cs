...
namespace WBS
{
    public partial class Hoofdmenu : Form
    {
        ...
        ListViewItem personlist;
        
        public Hoofdmenu()
        {
            InitializeComponent();
            refreshLabels();
            personlist = new ListViewItem("name");
            ListViewItem personlist2 = new ListViewItem("driverslicense");
            personlist.Checked = true;
            Person person1 = new Person();
            person1.Name = "asd";
            personlist.SubItems.Add(person1.Name);
            personlist.SubItems.Add(new Person().Name = "ab");
            personlist.SubItems.Add(new Person().Name = "ds");
            personlist2.SubItems.Add(new Person().DriversLicense.ToString());
            listView1.Items.Add(personlist);
            listView1.Items.Add(personlist2);
